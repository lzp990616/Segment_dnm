...
class Channelblock(nn.Module):
    ...
    def forward(self, x):
        ...
        conv3 = nn.Conv2d(self.out_channels*2, self.out_channels, kernel_size=1, padding=0)
        # (data_a_a1.to('cuda:1'))
        conv3 = conv3.to('cuda:1')
        # pdb.set_trace()
        conv3_output = conv3(data_a_a1.to('cuda:1'))
        batch3 = nn.BatchNorm2d(self.out_channels).to('cuda:1')(conv3_output)
